	...
	public function widget( $args, $instance ) {
		...
		if( $posts_query->have_posts() ):
			...
			while( $posts_query->have_posts() ): $posts_query->the_post();
 					//$posted_on = human_time_diff(get_the_time('U'), current_time('timestamp')); echo $posted_on." ago";
					echo "<li>";
					echo '<a href="'.get_the_permalink().'" class="post-img"><img class="retina" src="'.sunset_get_attachment().'" style=""  alt=""></a>
										<div class="post-content">
												<h6 class="post-title"><a href="'.get_the_permalink().'">'.get_the_title().'</a></h6>
												<div class="date"><i class="fa fa-user-o" aria-hidden="true"></i> '.human_time_diff(get_the_time('U'), current_time('timestamp')).'</div>
											</li>';
			...
			endwhile;
				...
				echo "</ul><br>";
				echo "<div class='text-sm-center viewmore_widget'><strong>View More</strong></div>";
